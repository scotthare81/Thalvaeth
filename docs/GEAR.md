...
Fast weapons emphasize cadence, mobility and bleed at lower per-hit impact. Dagger forms also retain explicit butcher capability.
...
- exact stable weapon/armour node keys before persisted data ships;
...
- final per-slot wear rates and repair costs;
